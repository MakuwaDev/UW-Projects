...
// extern size_t is_sumset_intersection_cnt;
// extern size_t does_sumset_contain_cnt;
// extern size_t sumset_add_cnt;
// extern size_t get_sumset_intersection_size_cnt;
